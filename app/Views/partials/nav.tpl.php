...
<nav class="navbar navbar-dark fixed-top col-12 ">
    <div class="container navbar--container  col-12 d-flex justify-content-center align-content-center flex-md-row justify-content-lg-between" ;>
        ...
        <div class="navbar--menu col-12 d-flex justify-content-center align-items-center pt-0 col-md- col-lg-7">
            <ul class="nav col-12 flex-column flex-md-row justify-content-md-end">
                ...
                <li class="nav-item nav-item-btn nav-link--article col-12 col-md-2  ">
                    <a class="nav-link nav-link-navbar d-flex justify-content-center align-items-center " href="<?= $router->generate('article-list') ?>">
                        <div><p class="m-0"> Articles </p></div>
                        <!-- <i class="fas fa-chevron-right arrow ml-3"></i> -->
                    </a>
                </li>
                <li class="nav-item nav-item-btn nav-link--article col-12 col-md-2  ">
                    <a class="nav-link nav-link-navbar d-flex justify-content-center align-items-center " href="<?= $router->generate('article-categories') ?>">
                        <div><p class="m-0"> Categories </p></div>
                    </a>
                </li>
